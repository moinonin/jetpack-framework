...
#### Installation  
[Windows 64-bit](https://github.com/moinonin/jetpack-framework/raw/master/jetpack_1.01-1_win64.zip)  
For windows users, she-bang can be cloned or downloaded directly from [github repository](https://github.com/moinonin/jetpack-framework). The rest of the installation follows extracting the zip file to your preferred location, opening the content folders, and double-clicking the executable file. That will install the program for everyday use. You may optionally create a desktop shortcut just as you do with many of your applications.  

### Linux X86-64 Users:
[Linux X86-64](https://github.com/moinonin/jetpack-framework/raw/master/jetpack_1.01-1_amd64.deb)
#### Installation
Upon cloning or downloading the application from our [github repository](https://github.com/moinonin/jetpack-framework), open your favorite terminal application, navigate to the source directory (where it is downloaded to) and install it by running the following commands:
```
$ sudo apt-get install ./jetpack_<version>_amd64.deb
```
...
Note, selecting 'jetpack' instead of './jetpack_1.01-1_amd64.deb'  
...
jetpack_1.01-1_amd64.deb jetpack amd64 1.01-1 [30.8 kB]  
Selecting previously unselected package jetpack.  
(Reading database ... 269205 files and directories currently installed.)  
Preparing to unpack .../jetpack_1.01-1_amd64.deb ...  
Unpacking jetpack (1.01-1) ...  
Processing triggers for menu (2.1.47+b1) ...  
Setting up jetpack (1.01-1) ...  
Processing triggers for menu (2.1.47+b1) ...  
================== end =========>  
## JetPack Usage
...
#=================== start ====================================#  
> she-bang@1.0.0 dev /home/rotich/Desktop/jetpack/my-website  
> npm run serve & npm run app  
> she-bang@1.0.0 serve /home/rotich/Desktop/jetpack/my-website  
> http-server  
> she-bang@1.0.0 app /home/rotich/Desktop/jetpack/my-website  
> ./index.sh  
...
## Conclusion
If you have read this guide up to this point, you should be ready to hit the road with JetPack static site generator and API fetcher. It is my sincere hope that you will find as much joy in utilizing this tool, as I did writing its code.
